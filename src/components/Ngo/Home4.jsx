    ...
    return (
        <Box w="90%" ml={{ lg: "12vw", md: "6vw", sm: "6vw", base: "6vw" }} >
            <Flex className='home4flex'>
                ...
                <VStack bgImage={"https://media.istockphoto.com/id/1355017147/photo/group-of-teamwork-high-five-team-together-hands-raise-up-power-partner-diversity-multiethnic.jpg?b=1&s=170667a&w=0&k=20&c=K4qf9Wz8FqSLX1iawNS99Nk4GTEPxdKieiVs4s8w-0k="} 
                bgSize="cover"
