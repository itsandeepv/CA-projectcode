...
import { gst_ragistration_DataArr } from "./gst_ragistrationData";
import { Link } from "react-scroll";
import "../../../../styles/ContanerForLowerHomeContent.css";

let links = [
    { link: "Overview", id: "gst_ragistration_overviewId" },
    { link: "Documents Needed", id: "gst_ragistration_documentNeededId" },
    { link: "Steps", id: "gst_ragistration_stepsId" },
    { link: "Registeration Package", id: "gst_ragistration_registerationId" },
    { link: "Checklist", id: "gst_ragistration_checklist" },
    { link: "Features", id: "gst_ragistration_featureId" },
    { link: "Restriction", id: "gst_ragistration_restrictionId" },
    { link: "Advantages", id: "gst_ragistration_advantageId" },
    { link: "Why us?", id: "gst_ragistration_whyusId" },
    { link: "FAQ", id: "gst_ragistration_faqId" },
    { link: "Partner Benifits", id: "gst_ragistration_partnerBenefitId" }
]
        ...
        <Box className='ContanerForHome6Content'>
            ...
            <Box className='middleSectionForHome6Content'>
                <Box className='WithoutAccorionContainer'>
                    {
                        gst_ragistration_DataArr.map((e, i) => (
                            <Box id={e.id}>
                                <Text
                                    textAlign="start"
                                    fontWeight="bold"
