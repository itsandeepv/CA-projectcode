...
import { gst_advisory_portal_DataArr } from "./gst_advisory_portalData";
import { Link } from "react-scroll";
import "../../../../styles/ContanerForLowerHomeContent.css";

let links = [
    { link: "Overview", id: "gst_advisory_portal_overviewId" },
    { link: "Documents Needed", id: "gst_advisory_portal_documentNeededId" },
    { link: "Steps", id: "gst_advisory_portal_stepsId" },
    { link: "Registeration Package", id: "gst_advisory_portal_registerationId" },
    { link: "Checklist", id: "gst_advisory_portal_checklist" },
    { link: "Features", id: "gst_advisory_portal_featureId" },
    { link: "Restriction", id: "gst_advisory_portal_restrictionId" },
    { link: "Advantages", id: "gst_advisory_portal_advantageId" },
    { link: "Why us?", id: "gst_advisory_portal_whyusId" },
    { link: "FAQ", id: "gst_advisory_portal_faqId" },
    { link: "Partner Benifits", id: "gst_advisory_portal_partnerBenefitId" }
]
        ...
        <Box className='ContanerForHome6Content'>
            ...
            <Box className='middleSectionForHome6Content'>
                <Box className='WithoutAccorionContainer'>
                    {
                        gst_advisory_portal_DataArr.map((e, i) => (
                            <Box id={e.id}>
                                <Text
                                    textAlign="start"
                                    fontWeight="bold"
