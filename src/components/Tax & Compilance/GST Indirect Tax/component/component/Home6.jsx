...
import { gst_indirect_tax_DataArr } from "./gst_indirect_tax_Data";
import { Link } from "react-scroll";
import "../../../../../styles/ContanerForLowerHomeContent.css";

let links = [
    { link: "Overview", id: "gst_indirect_tax_overviewId" },
    { link: "Documents Needed", id: "gst_indirect_tax_documentNeededId" },
    { link: "Steps", id: "gst_indirect_tax_stepsId" },
    { link: "Registeration Package", id: "gst_indirect_tax_registerationId" },
    { link: "Checklist", id: "gst_indirect_tax_checklist" },
    { link: "Features", id: "gst_indirect_tax_featureId" },
    { link: "Restriction", id: "gst_indirect_tax_restrictionId" },
    { link: "Advantages", id: "gst_indirect_tax_advantageId" },
    { link: "Why us?", id: "gst_indirect_tax_whyusId" },
    { link: "FAQ", id: "gst_indirect_tax_faqId" },
    { link: "Partner Benifits", id: "gst_indirect_tax_partnerBenefitId" }
]
        ...
        <Box className='ContanerForHome6Content'>
            ...
            <Box className='middleSectionForHome6Content'>
                <Box className='WithoutAccorionContainer'>
                    {
                        gst_indirect_tax_DataArr.map((e, i) => (
                            <Box id={e.id}>
                                <Text
                                    textAlign="start"
                                    fontWeight="bold"
