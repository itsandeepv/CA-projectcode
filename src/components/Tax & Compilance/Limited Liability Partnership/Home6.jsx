...
import Exclusiive from '../../../components/Exclusiive';
import { DataArr } from "./Data";
import { Link } from "react-scroll";
import "../../../styles/ContanerForLowerHomeContent.css";

let links = [
    { link: "Overview", id: "overviewId" },
    { link: "Documents Needed", id: "documentNeededId" },
    { link: "Steps", id: "stepsId" },
    { link: "Registeration Package", id: "registerationId" },
    { link: "Checklist", id: "checklist" },
    { link: "Features", id: "featureId" },
    { link: "Restriction", id: "restrictionId" },
    { link: "Advantages", id: "advantageId" },
    { link: "Why us?", id: "whyusId" },
    { link: "FAQ", id: "faqId" },
    { link: "Partner Benifits", id: "partnerBenefitId" }
]
                        ...
                        links.map((e, i) => (
                            <Link key={i} onClick={() => { setActive(i) }} smooth spy to={e.id} offset={-100} >
                                <Box
                                    ...
                                    style={{
                                        color: active === i ? "black" : "black",
                                        mt: "1%",
                                        backgroundColor: i === active ? "orange" : "#e8e8eb"
                                    }}
                                >
                                    {e.link}
                                </Box>
