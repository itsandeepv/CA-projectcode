...
import { SingaporeIncorporationData } from "./SingaporeIncorporationData";
import { Link } from "react-scroll";
import "../../../styles/ContanerForLowerHomeContent.css";

let links = [
    { link: "Overview", id: "SingaporeIncorporation_overviewId" },
    { link: "Documents Needed", id: "SingaporeIncorporation_documentNeededId" },
    { link: "Steps", id: "SingaporeIncorporation_stepsId" },
    { link: "Registeration Package", id: "SingaporeIncorporation_registerationId" },
    { link: "Checklist", id: "SingaporeIncorporation_checklist" },
    { link: "Features", id: "SingaporeIncorporation_featureId" },
    { link: "Restriction", id: "SingaporeIncorporation_restrictionId" },
    { link: "Advantages", id: "SingaporeIncorporation_advantageId" },
    { link: "Why us?", id: "SingaporeIncorporation_whyusId" },
    { link: "FAQ", id: "SingaporeIncorporation_faqId" },
    { link: "Partner Benifits", id: "SingaporeIncorporation_partnerBenefitId" }
]
        ...
        <Box className='ContanerForHome6Content'>
            ...
            <Box className='middleSectionForHome6Content'>
                <Box className='WithoutAccorionContainer'>
                    {
                        SingaporeIncorporationData.map((e, i) => (
                            <Box id={e.id}>
                                <Text
                                    textAlign="start"
                                    fontWeight="bold"
