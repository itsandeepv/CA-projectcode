...
import { Apply_MSME_UdyamRegistrationOnlineData } from "./Apply_MSME_UdyamRegistrationOnlineData";
import { Link } from "react-scroll";
import "../../../styles/ContanerForLowerHomeContent.css";

let links = [
    { link: "Overview", id: "Apply_MSME_UdyamRegistrationOnline_overviewId" },
    { link: "Documents Needed", id: "Apply_MSME_UdyamRegistrationOnline_documentNeededId" },
    { link: "Steps", id: "Apply_MSME_UdyamRegistrationOnline_stepsId" },
    { link: "Registeration Package", id: "Apply_MSME_UdyamRegistrationOnline_registerationId" },
    { link: "Checklist", id: "Apply_MSME_UdyamRegistrationOnline_checklist" },
    { link: "Features", id: "Apply_MSME_UdyamRegistrationOnline_featureId" },
    { link: "Restriction", id: "Apply_MSME_UdyamRegistrationOnline_restrictionId" },
    { link: "Advantages", id: "Apply_MSME_UdyamRegistrationOnline_advantageId" },
    { link: "Why us?", id: "Apply_MSME_UdyamRegistrationOnline_whyusId" },
    { link: "FAQ", id: "Apply_MSME_UdyamRegistrationOnline_faqId" },
    { link: "Partner Benifits", id: "Apply_MSME_UdyamRegistrationOnline_partnerBenefitId" }
]
        ...
        <Box className='ContanerForHome6Content'>
            ...
            <Box className='middleSectionForHome6Content'>
                <Box className='WithoutAccorionContainer'>
                    {
                        Apply_MSME_UdyamRegistrationOnlineData.map((e, i) => (
                            <Box id={e.id}>
                                <Text
                                    textAlign="start"
                                    fontWeight="bold"
