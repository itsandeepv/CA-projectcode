        ...
        <Box className="HeaderContainerForPrivateLimited" bg="#f2f1f0">
            <Box className="firsBox_HeaderContainer">
                <Box mt={{ base: "7%", sm: "7%", md: "6%", lg: "auto", xl: "auto" }}>
                    <Box fontWeight="bold" display="flex" textAlign="left" color="black" fontSize={{ base: "130%", sm: "200%", md: "250%", lg: "300%", xl: "350%" }} >One Person Company (OPC) Registration in India</Box>
                    <Box fontWeight="500" display="flex" textAlign="left" fontSize={{ base: "100%", sm: "130%", md: "120%", lg: "140%", xl: "160%" }} color="gray" mt={5}><Image pt={0} src={blue_whitetick} alt="" /> <Text ml={2}>Get your application submitted with in 10 Days</Text></Box>
                    <Box fontWeight="500" display="flex" textAlign="left" fontSize={{ base: "100%", sm: "130%", md: "120%", lg: "140%", xl: "160%" }} color="gray"><Image pt={0} src={blue_whitetick} alt="" /> <Text ml={2}>Transparent process, thorough follow up and regular updates</Text></Box>
                </Box>
