...
import { SoleProprietorshipData } from "./SoleProprietorshipData";
import { Link } from "react-scroll";
import "../../../styles/ContanerForLowerHomeContent.css";

let links = [
    { link: "Overview", id: "SoleProprietorshipDataoverviewId" },
    { link: "Documents Needed", id: "SoleProprietorshipDatadocumentNeededId" },
    { link: "Steps", id: "SoleProprietorshipDatastepsId" },
    { link: "Registeration Package", id: "SoleProprietorshipDataregisterationId" },
    { link: "Checklist", id: "SoleProprietorshipDatachecklist" },
    { link: "Features", id: "SoleProprietorshipDatafeatureId" },
    { link: "Restriction", id: "SoleProprietorshipDatarestrictionId" },
    { link: "Advantages", id: "SoleProprietorshipDataadvantageId" },
    { link: "Why us?", id: "SoleProprietorshipDatawhyusId" },
    { link: "FAQ", id: "SoleProprietorshipDatafaqId" },
    { link: "Partner Benifits", id: "SoleProprietorshipDatapartnerBenefitId" }
]
        ...
        <Box className='ContanerForHome6Content'>
            ...
            <Box className='middleSectionForHome6Content'>
                <Box className='WithoutAccorionContainer'>
                    {
                        SoleProprietorshipData.map((e, i) => (
                            <Box id={e.id}>
                                <Text
                                    textAlign="start"
                                    fontWeight="bold"
