...
import { HallmarkRegistrationData } from "./HallmarkRegistrationData";
import { Link } from "react-scroll";
import "../../../styles/ContanerForLowerHomeContent.css";

let links = [
    { link: "Overview", id: "HallmarkRegistration_overviewId" },
    { link: "Documents Needed", id: "HallmarkRegistration_documentNeededId" },
    { link: "Steps", id: "HallmarkRegistration_stepsId" },
    { link: "Registeration Package", id: "HallmarkRegistration_registerationId" },
    { link: "Checklist", id: "HallmarkRegistration_checklist" },
    { link: "Features", id: "HallmarkRegistration_featureId" },
    { link: "Restriction", id: "HallmarkRegistration_restrictionId" },
    { link: "Advantages", id: "HallmarkRegistration_advantageId" },
    { link: "Why us?", id: "HallmarkRegistration_whyusId" },
    { link: "FAQ", id: "HallmarkRegistration_faqId" },
    { link: "Partner Benifits", id: "HallmarkRegistration_partnerBenefitId" }
]
        ...
        <Box className='ContanerForHome6Content'>
            ...
            <Box className='middleSectionForHome6Content'>
                <Box className='WithoutAccorionContainer'>
                    {
                        HallmarkRegistrationData.map((e, i) => (
                            <Box id={e.id}>
                                <Text
                                    textAlign="start"
                                    fontWeight="bold"
