        ...
        <Box className="HeaderContainerForPrivateLimited" bg="#f2f1f0">
            <Box className="firsBox_HeaderContainer">
                <Box mt={{ base: "7%", sm: "7%", md: "6%", lg: "auto", xl: "auto" }}>
                    <Box fontWeight="bold" display="flex" flexDir="column" textAlign="left" color="black" fontSize={{ base: "130%", sm: "200%", md: "250%", lg: "300%", xl: "350%" }} borderBottom="3px solid #ffc107">Partnership Firm Registration</Box>
                    <Box fontWeight="500" display="flex" textAlign="left" fontSize={{ base: "100%", sm: "130%", md: "120%", lg: "140%", xl: "160%" }} color="gray" mt={5}><Image pt={0} height="fit-content" mt={0} src={blue_whitetick} alt="" /> <Text ml={2}>Partnership firm registration deed drafted within 3 days, completely online & hasslefree T&C*</Text></Box>
                    <Box fontWeight="500" display="flex" textAlign="left" fontSize={{ base: "100%", sm: "130%", md: "120%", lg: "140%", xl: "160%" }} color="gray"><Image pt={0} height="fit-content" mt={0} src={blue_whitetick} alt="" /> <Text ml={2}>Transparent process through follow-up and regular updates</Text></Box>
                </Box>
                <Box display="flex" flexDirection={{ base: "column", sm: "column", md: "row" }}>
                    <Box
                        ...
                        textAlign="left"
                    >
                        <Image width="9%" src={smallcretificate} alt="" />
                        <Text
                            fontWeight="500"
                            ml={2}
                            display="flex"
                            ...
                            mt={5}
                        >
                        View sample Certificate / Agreement</Text>
                    </Box>
                </Box>
