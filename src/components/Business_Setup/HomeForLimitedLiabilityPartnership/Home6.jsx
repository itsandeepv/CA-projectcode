...
import { LimitedLiabilityPartnershipData } from "./LimitedLiabilityPartnershipData";
import { Link } from "react-scroll";
import "../../../styles/ContanerForLowerHomeContent.css";

let links = [
    { link: "Overview", id: "LimitedLiabilityPartnershipDataoverviewId" },
    { link: "Documents Needed", id: "LimitedLiabilityPartnershipDatadocumentNeededId" },
    { link: "Steps", id: "LimitedLiabilityPartnershipDatastepsId" },
    { link: "Registeration Package", id: "LimitedLiabilityPartnershipDataregisterationId" },
    { link: "Checklist", id: "LimitedLiabilityPartnershipDatachecklist" },
    { link: "Features", id: "LimitedLiabilityPartnershipDatafeatureId" },
    { link: "Restriction", id: "LimitedLiabilityPartnershipDatarestrictionId" },
    { link: "Advantages", id: "LimitedLiabilityPartnershipDataadvantageId" },
    { link: "Why us?", id: "LimitedLiabilityPartnershipDatawhyusId" },
    { link: "FAQ", id: "LimitedLiabilityPartnershipDatafaqId" },
    { link: "Partner Benifits", id: "LimitedLiabilityPartnershipDatapartnerBenefitId" }
]
        ...
        <Box className='ContanerForHome6Content'>
            ...
            <Box className='middleSectionForHome6Content'>
                <Box className='WithoutAccorionContainer'>
                    {
                        LimitedLiabilityPartnershipData.map((e, i) => (
                            <Box id={e.id}>
                                <Text
                                    textAlign="start"
                                    fontWeight="bold"
