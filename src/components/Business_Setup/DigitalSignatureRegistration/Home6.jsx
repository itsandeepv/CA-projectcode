...
import { DigitalSignatureRegistrationData } from "./DigitalSignatureRegistrationData";
import { Link } from "react-scroll";
import "../../../styles/ContanerForLowerHomeContent.css";

let links = [
    { link: "Overview", id: "DigitalSignatureRegistration_overviewId" },
    { link: "Documents Needed", id: "DigitalSignatureRegistration_documentNeededId" },
    { link: "Steps", id: "DigitalSignatureRegistration_stepsId" },
    { link: "Registeration Package", id: "DigitalSignatureRegistration_registerationId" },
    { link: "Checklist", id: "DigitalSignatureRegistration_checklist" },
    { link: "Features", id: "DigitalSignatureRegistration_featureId" },
    { link: "Restriction", id: "DigitalSignatureRegistration_restrictionId" },
    { link: "Advantages", id: "DigitalSignatureRegistration_advantageId" },
    { link: "Why us?", id: "DigitalSignatureRegistration_whyusId" },
    { link: "FAQ", id: "DigitalSignatureRegistration_faqId" },
    { link: "Partner Benifits", id: "DigitalSignatureRegistration_partnerBenefitId" }
]
        ...
        <Box className='ContanerForHome6Content'>
            ...
            <Box className='middleSectionForHome6Content'>
                <Box className='WithoutAccorionContainer'>
                    {
                        DigitalSignatureRegistrationData.map((e, i) => (
                            <Box id={e.id}>
                                <Text
                                    textAlign="start"
                                    fontWeight="bold"
