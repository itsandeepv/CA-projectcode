...
let links = [
    { link: "Overview", id: "WebsiteDevelopment_overviewId" },
    { link: "Documents Needed", id: "WebsiteDevelopment_documentNeededId" },
    { link: "Steps", id: "WebsiteDevelopment_stepsId" },
    { link: "Registeration Package", id: "WebsiteDevelopment_registerationId" },
    { link: "Checklist", id: "WebsiteDevelopment_checklist" },
    { link: "Features", id: "WebsiteDevelopment_featureId" },
    { link: "Restriction", id: "WebsiteDevelopment_restrictionId" },
    { link: "Advantages", id: "WebsiteDevelopment_advantageId" },
    { link: "Why us?", id: "WebsiteDevelopment_whyusId" },
    { link: "FAQ", id: "WebsiteDevelopment_faqId" },
    { link: "Partner Benifits", id: "WebsiteDevelopment_partnerBenefitId" }
]
        ...
        <Box className='ContanerForHome6Content'>
            ...
            <Box className='middleSectionForHome6Content'>
                <Box className='WithoutAccorionContainer'>
                    {
                        WebsiteDevelopmentData.map((e, i) => (
                            <Box id={e.id}>
                                <Text
                                    textAlign="start"
                                    fontWeight="bold"
