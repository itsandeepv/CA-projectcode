...
import { ImporterExporterCodeRegistrationData } from "./ImporterExporterCodeRegistrationData";
import { Link } from "react-scroll";
import "../../../styles/ContanerForLowerHomeContent.css";

let links = [
    { link: "Overview", id: "ImporterExporterCodeRegistration_overviewId" },
    { link: "Documents Needed", id: "ImporterExporterCodeRegistration_documentNeededId" },
    { link: "Steps", id: "ImporterExporterCodeRegistration_stepsId" },
    { link: "Registeration Package", id: "ImporterExporterCodeRegistration_registerationId" },
    { link: "Checklist", id: "ImporterExporterCodeRegistration_checklist" },
    { link: "Features", id: "ImporterExporterCodeRegistration_featureId" },
    { link: "Restriction", id: "ImporterExporterCodeRegistration_restrictionId" },
    { link: "Advantages", id: "ImporterExporterCodeRegistration_advantageId" },
    { link: "Why us?", id: "ImporterExporterCodeRegistration_whyusId" },
    { link: "FAQ", id: "ImporterExporterCodeRegistration_faqId" },
    { link: "Partner Benifits", id: "ImporterExporterCodeRegistration_partnerBenefitId" }
]
        ...
        <Box className='ContanerForHome6Content'>
            ...
            <Box className='middleSectionForHome6Content'>
                <Box className='WithoutAccorionContainer'>
                    {
                        ImporterExporterCodeRegistrationData.map((e, i) => (
                            <Box id={e.id}>
                                <Text
                                    textAlign="start"
                                    fontWeight="bold"
