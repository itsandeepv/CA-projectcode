...
const GSTR1_cdnr = () => {
  ...
  return (
    <>
      ...
      >
        <Heading size='md' mt='2'>GSTR1 cdnr</Heading>
          ...
          <Table>
            <Thead>
              ...
              <Th style={{ border: '1px solid gray' }}>GSTIN/UIN of Recipient</Th>
                ...
                <Th style={{ border: '1px solid gray' }}>Note Number</Th>
                <Th style={{ border: '1px solid gray' }}>Note Date</Th>
