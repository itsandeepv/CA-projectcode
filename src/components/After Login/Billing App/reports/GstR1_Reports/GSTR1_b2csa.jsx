...
const GSTR1_b2csa = () => {
  ...
  return (
    <>
      ...
      >
        <Heading size='md' mt='2'> GSTR1 B2CSA</Heading>
        ...
        >
          <Table>
            <Thead>
              <Tr>
              <Th style={{ border: '1px solid gray' }}>Financial Year</Th>
                <Th style={{ border: '1px solid gray' }}>Original Month</Th>
