...
const GSTR1_cdnura = () => {
  ...
  return (
    <>
      ...
      >
        <Heading size='md' mt='2'> GSTR1 cdnura</Heading>
        ...
        >
          <Table>
            <Thead>
              <Tr>
              <Th style={{ border: '1px solid gray' }}>UR Type</Th>
                <Th style={{ border: '1px solid gray' }}>Original Note Number</Th>
                <Th style={{ border: '1px solid gray' }}>Original Note Date</Th>
                <Th style={{ border: '1px solid gray' }}>Revised Note Number</Th>
                <Th style={{ border: '1px solid gray' }}>Revised Note Date</Th>
                <Th style={{ border: '1px solid gray' }}>Note Type</Th>
                <Th style={{ border: '1px solid gray' }}>Place of Supply</Th>
                <Th style={{ border: '1px solid gray' }}>Note Supply Type</Th>
                <Th style={{ border: '1px solid gray' }}>Note Value</Th>
