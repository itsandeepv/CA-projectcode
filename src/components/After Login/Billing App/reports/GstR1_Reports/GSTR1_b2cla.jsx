    ...
    return (
        <>
            <Box Flex='1' padding='15px'>
                <Heading size='md' mt='2'>GSTR1 B2CLA</Heading>
                ...
                >
                    <Table>
                        <Thead>
                            <Tr>
                                <Th style={{ border: '1px solid gray' }}>Original Invoice Number</Th>
                                <Th style={{ border: '1px solid gray' }}>Original Invoice date</Th>
                                <Th style={{ border: '1px solid gray' }}>Original Place Of Supply</Th>
                                <Th style={{ border: '1px solid gray' }}>Revised Invoice Number</Th>
                                <Th style={{ border: '1px solid gray' }}>Revised Invoice date</Th>
