import { Box, Flex, HStack, Image, Input, Select, Text, VStack } from '@chakra-ui/react'
            ...
            <Flex className='home4flex'>
                <Box>
                    ...
                    <h1 style={{ fontSize: "40px", fontWeight: "bold", textShadow: "0px 2px, 2px 0px, 2px 2px" }}>
                        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Voluptate fuga officiis quam sequi veritat
                    </h1>
                    <Text {...stylePropP3} >
                ...
                <VStack bgSize={"contain"} bgImage={"https://cdn.pixabay.com/photo/2017/10/25/19/46/piggy-bank-2889046__340.jpg"} className="home4vstack"
                >
