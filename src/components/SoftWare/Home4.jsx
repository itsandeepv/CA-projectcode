    ...
    return (
        <Box w="90%" ml={{ lg: "12vw", md: "6vw", sm: "6vw", base: "6vw" }} >
            <Flex className='home4flex'>
                ...
                <VStack 
                bgSize={"cover"}
                bgImage={"https://media.istockphoto.com/id/1075599562/photo/programmer-working-with-program-code.jpg?b=1&s=170667a&w=0&k=20&c=KFWVhwfcu8aAl4aTpsSCAE4PP-qBb4rdWjDe4eSCng0="} className="home4vstack"
                >
