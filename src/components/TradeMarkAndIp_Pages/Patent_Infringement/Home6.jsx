...
import { Patent_InfringementData } from "./Patent_InfringementData";
import { Link } from "react-scroll";
import "../../../styles/ContanerForLowerHomeContent.css";

let links = [
    { link: "Overview", id: "Patent_Infringement_overviewId" },
    { link: "Documents Needed", id: "Patent_Infringement_documentNeededId" },
    { link: "Steps", id: "Patent_Infringement_stepsId" },
    { link: "Registeration Package", id: "Patent_Infringement_registerationId" },
    { link: "Checklist", id: "Patent_Infringement_checklist" },
    { link: "Features", id: "Patent_Infringement_featureId" },
    { link: "Restriction", id: "Patent_Infringement_restrictionId" },
    { link: "Advantages", id: "Patent_Infringement_advantageId" },
    { link: "Why us?", id: "Patent_Infringement_whyusId" },
    { link: "FAQ", id: "Patent_Infringement_faqId" },
    { link: "Partner Benifits", id: "Patent_Infringement_partnerBenefitId" }
]
        ...
        <Box className='ContanerForHome6Content'>
            ...
            <Box className='middleSectionForHome6Content'>
                <Box className='WithoutAccorionContainer'>
                    {
                        Patent_InfringementData.map((e, i) => (
                            <Box id={e.id}>
                                <Text
                                    textAlign="start"
                                    fontWeight="bold"
