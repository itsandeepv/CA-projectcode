...
import { Search_For_TrademarkData } from "./Search_For_TrademarkData";
import { Link } from "react-scroll";
import "../../../styles/ContanerForLowerHomeContent.css";

let links = [
    { link: "Overview", id: "Search_For_Trademark_overviewId" },
    { link: "Documents Needed", id: "Search_For_Trademark_documentNeededId" },
    { link: "Steps", id: "Search_For_Trademark_stepsId" },
    { link: "Registeration Package", id: "Search_For_Trademark_registerationId" },
    { link: "Checklist", id: "Search_For_Trademark_checklist" },
    { link: "Features", id: "Search_For_Trademark_featureId" },
    { link: "Restriction", id: "Search_For_Trademark_restrictionId" },
    { link: "Advantages", id: "Search_For_Trademark_advantageId" },
    { link: "Why us?", id: "Search_For_Trademark_whyusId" },
    { link: "FAQ", id: "Search_For_Trademark_faqId" },
    { link: "Partner Benifits", id: "Search_For_Trademark_partnerBenefitId" }
]
        ...
        <Box className='ContanerForHome6Content'>
            ...
            <Box className='middleSectionForHome6Content'>
                <Box className='WithoutAccorionContainer'>
                    {
                        Search_For_TrademarkData.map((e, i) => (
                            <Box id={e.id}>
                                <Text
                                    textAlign="start"
                                    fontWeight="bold"
