...
import { Copyright_RegistrationData } from "./Copyright_RegistrationData";
import { Link } from "react-scroll";
import "../../../styles/ContanerForLowerHomeContent.css";

let links = [
    { link: "Overview", id: "Copyright_Registration_overviewId" },
    { link: "Documents Needed", id: "Copyright_Registration_documentNeededId" },
    { link: "Steps", id: "Copyright_Registration_stepsId" },
    { link: "Registeration Package", id: "Copyright_Registration_registerationId" },
    { link: "Checklist", id: "Copyright_Registration_checklist" },
    { link: "Features", id: "Copyright_Registration_featureId" },
    { link: "Restriction", id: "Copyright_Registration_restrictionId" },
    { link: "Advantages", id: "Copyright_Registration_advantageId" },
    { link: "Why us?", id: "Copyright_Registration_whyusId" },
    { link: "FAQ", id: "Copyright_Registration_faqId" },
    { link: "Partner Benifits", id: "Copyright_Registration_partnerBenefitId" }
]
        ...
        <Box className='ContanerForHome6Content'>
            ...
            <Box className='middleSectionForHome6Content'>
                <Box className='WithoutAccorionContainer'>
                    {
                        Copyright_RegistrationData.map((e, i) => (
                            <Box id={e.id}>
                                <Text
                                    textAlign="start"
                                    fontWeight="bold"
