...
import { Trademark_InfringementData } from "./Trademark_InfringementData";
import { Link } from "react-scroll";
import "../../../styles/ContanerForLowerHomeContent.css";

let links = [
    { link: "Overview", id: "Trademark_Infringement_overviewId" },
    { link: "Documents Needed", id: "Trademark_Infringement_documentNeededId" },
    { link: "Steps", id: "Trademark_Infringement_stepsId" },
    { link: "Registeration Package", id: "Trademark_Infringement_registerationId" },
    { link: "Checklist", id: "Trademark_Infringement_checklist" },
    { link: "Features", id: "Trademark_Infringement_featureId" },
    { link: "Restriction", id: "Trademark_Infringement_restrictionId" },
    { link: "Advantages", id: "Trademark_Infringement_advantageId" },
    { link: "Why us?", id: "Trademark_Infringement_whyusId" },
    { link: "FAQ", id: "Trademark_Infringement_faqId" },
    { link: "Partner Benifits", id: "Trademark_Infringement_partnerBenefitId" }
]
        ...
        <Box className='ContanerForHome6Content'>
            ...
            <Box className='middleSectionForHome6Content'>
                <Box className='WithoutAccorionContainer'>
                    {
                        Trademark_InfringementData.map((e, i) => (
                            <Box id={e.id}>
                                <Text
                                    textAlign="start"
                                    fontWeight="bold"
