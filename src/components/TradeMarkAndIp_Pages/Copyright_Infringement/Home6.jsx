...
import { Copyright_InfringementData } from "./Copyright_InfringementData";
import { Link } from "react-scroll";
import "../../../styles/ContanerForLowerHomeContent.css";

let links = [
    { link: "Overview", id: "Copyright_Infringement_overviewId" },
    { link: "Documents Needed", id: "Copyright_Infringement_documentNeededId" },
    { link: "Steps", id: "Copyright_Infringement_stepsId" },
    { link: "Registeration Package", id: "Copyright_Infringement_registerationId" },
    { link: "Checklist", id: "Copyright_Infringement_checklist" },
    { link: "Features", id: "Copyright_Infringement_featureId" },
    { link: "Restriction", id: "Copyright_Infringement_restrictionId" },
    { link: "Advantages", id: "Copyright_Infringement_advantageId" },
    { link: "Why us?", id: "Copyright_Infringement_whyusId" },
    { link: "FAQ", id: "Copyright_Infringement_faqId" },
    { link: "Partner Benifits", id: "Copyright_Infringement_partnerBenefitId" }
]
        ...
        <Box className='ContanerForHome6Content'>
            ...
            <Box className='middleSectionForHome6Content'>
                <Box className='WithoutAccorionContainer'>
                    {
                        Copyright_InfringementData.map((e, i) => (
                            <Box id={e.id}>
                                <Text
                                    textAlign="start"
                                    fontWeight="bold"
