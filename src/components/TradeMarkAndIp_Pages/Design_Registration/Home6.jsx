...
import { Design_RegistrationData } from "./Design_RegistrationData";
import { Link } from "react-scroll";
import "../../../styles/ContanerForLowerHomeContent.css";

let links = [
    { link: "Overview", id: "Design_Registration_overviewId" },
    { link: "Documents Needed", id: "Design_Registration_documentNeededId" },
    { link: "Steps", id: "Design_Registration_stepsId" },
    { link: "Registeration Package", id: "Design_Registration_registerationId" },
    { link: "Checklist", id: "Design_Registration_checklist" },
    { link: "Features", id: "Design_Registration_featureId" },
    { link: "Restriction", id: "Design_Registration_restrictionId" },
    { link: "Advantages", id: "Design_Registration_advantageId" },
    { link: "Why us?", id: "Design_Registration_whyusId" },
    { link: "FAQ", id: "Design_Registration_faqId" },
    { link: "Partner Benifits", id: "Design_Registration_partnerBenefitId" }
]
        ...
        <Box className='ContanerForHome6Content'>
            ...
            <Box className='middleSectionForHome6Content'>
                <Box className='WithoutAccorionContainer'>
                    {
                        Design_RegistrationData.map((e, i) => (
                            <Box id={e.id}>
                                <Text
                                    textAlign="start"
                                    fontWeight="bold"
