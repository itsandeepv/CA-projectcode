...
import { Indian_Patent_SearchData } from "./Indian_Patent_SearchData";
import { Link } from "react-scroll";
import "../../../styles/ContanerForLowerHomeContent.css";

let links = [
    { link: "Overview", id: "Indian_Patent_Search_overviewId" },
    { link: "Documents Needed", id: "Indian_Patent_Search_documentNeededId" },
    { link: "Steps", id: "Indian_Patent_Search_stepsId" },
    { link: "Registeration Package", id: "Indian_Patent_Search_registerationId" },
    { link: "Checklist", id: "Indian_Patent_Search_checklist" },
    { link: "Features", id: "Indian_Patent_Search_featureId" },
    { link: "Restriction", id: "Indian_Patent_Search_restrictionId" },
    { link: "Advantages", id: "Indian_Patent_Search_advantageId" },
    { link: "Why us?", id: "Indian_Patent_Search_whyusId" },
    { link: "FAQ", id: "Indian_Patent_Search_faqId" },
    { link: "Partner Benifits", id: "Indian_Patent_Search_partnerBenefitId" }
]
        ...
        <Box className='ContanerForHome6Content'>
            ...
            <Box className='middleSectionForHome6Content'>
                <Box className='WithoutAccorionContainer'>
                    {
                        Indian_Patent_SearchData.map((e, i) => (
                            <Box id={e.id}>
                                <Text
                                    textAlign="start"
                                    fontWeight="bold"
