...
import { Provisonal_ApplicationData } from "./Provisonal_ApplicationData";
import { Link } from "react-scroll";
import "../../../styles/ContanerForLowerHomeContent.css";

let links = [
    { link: "Overview", id: "Provisonal_Application_overviewId" },
    { link: "Documents Needed", id: "Provisonal_Application_documentNeededId" },
    { link: "Steps", id: "Provisonal_Application_stepsId" },
    { link: "Registeration Package", id: "Provisonal_Application_registerationId" },
    { link: "Checklist", id: "Provisonal_Application_checklist" },
    { link: "Features", id: "Provisonal_Application_featureId" },
    { link: "Restriction", id: "Provisonal_Application_restrictionId" },
    { link: "Advantages", id: "Provisonal_Application_advantageId" },
    { link: "Why us?", id: "Provisonal_Application_whyusId" },
    { link: "FAQ", id: "Provisonal_Application_faqId" },
    { link: "Partner Benifits", id: "Provisonal_Application_partnerBenefitId" }
]
        ...
        <Box className='ContanerForHome6Content'>
            ...
            <Box className='middleSectionForHome6Content'>
                <Box className='WithoutAccorionContainer'>
                    {
                        Provisonal_ApplicationData.map((e, i) => (
                            <Box id={e.id}>
                                <Text
                                    textAlign="start"
                                    fontWeight="bold"
