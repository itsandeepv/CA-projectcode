...
import { Respond_To_TM_ObjectionData } from "./Respond_To_TM_ObjectionData";
import { Link } from "react-scroll";
import "../../../styles/ContanerForLowerHomeContent.css";

let links = [
    { link: "Overview", id: "Respond_To_TM_Objection_overviewId" },
    { link: "Documents Needed", id: "Respond_To_TM_Objection_documentNeededId" },
    { link: "Steps", id: "Respond_To_TM_Objection_stepsId" },
    { link: "Registeration Package", id: "Respond_To_TM_Objection_registerationId" },
    { link: "Checklist", id: "Respond_To_TM_Objection_checklist" },
    { link: "Features", id: "Respond_To_TM_Objection_featureId" },
    { link: "Restriction", id: "Respond_To_TM_Objection_restrictionId" },
    { link: "Advantages", id: "Respond_To_TM_Objection_advantageId" },
    { link: "Why us?", id: "Respond_To_TM_Objection_whyusId" },
    { link: "FAQ", id: "Respond_To_TM_Objection_faqId" },
    { link: "Partner Benifits", id: "Respond_To_TM_Objection_partnerBenefitId" }
]
        ...
        <Box className='ContanerForHome6Content'>
            ...
            <Box className='middleSectionForHome6Content'>
                <Box className='WithoutAccorionContainer'>
                    {
                        Respond_To_TM_ObjectionData.map((e, i) => (
                            <Box id={e.id}>
                                <Text
                                    textAlign="start"
                                    fontWeight="bold"
