...
import { Well_Known_TrademarkData } from "./Well_Known_TrademarkData";
import { Link } from "react-scroll";
import "../../../styles/ContanerForLowerHomeContent.css";

let links = [
    { link: "Overview", id: "Well_Known_Trademark_overviewId" },
    { link: "Documents Needed", id: "Well_Known_Trademark_documentNeededId" },
    { link: "Steps", id: "Well_Known_Trademark_stepsId" },
    { link: "Registeration Package", id: "Well_Known_Trademark_registerationId" },
    { link: "Checklist", id: "Well_Known_Trademark_checklist" },
    { link: "Features", id: "Well_Known_Trademark_featureId" },
    { link: "Restriction", id: "Well_Known_Trademark_restrictionId" },
    { link: "Advantages", id: "Well_Known_Trademark_advantageId" },
    { link: "Why us?", id: "Well_Known_Trademark_whyusId" },
    { link: "FAQ", id: "Well_Known_Trademark_faqId" },
    { link: "Partner Benifits", id: "Well_Known_Trademark_partnerBenefitId" }
]
        ...
        <Box className='ContanerForHome6Content'>
            ...
            <Box className='middleSectionForHome6Content'>
                <Box className='WithoutAccorionContainer'>
                    {
                        Well_Known_TrademarkData.map((e, i) => (
                            <Box id={e.id}>
                                <Text
                                    textAlign="start"
                                    fontWeight="bold"
