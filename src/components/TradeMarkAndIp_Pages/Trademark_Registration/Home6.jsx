...
import { Trademark_RegistrationData } from "./Trademark_RegistrationData";
import { Link } from "react-scroll";
import "../../../styles/ContanerForLowerHomeContent.css";

let links = [
    { link: "Overview", id: "Trademark_Registration_overviewId" },
    { link: "Documents Needed", id: "Trademark_Registration_documentNeededId" },
    { link: "Steps", id: "Trademark_Registration_stepsId" },
    { link: "Registeration Package", id: "Trademark_Registration_registerationId" },
    { link: "Checklist", id: "Trademark_Registration_checklist" },
    { link: "Features", id: "Trademark_Registration_featureId" },
    { link: "Restriction", id: "Trademark_Registration_restrictionId" },
    { link: "Advantages", id: "Trademark_Registration_advantageId" },
    { link: "Why us?", id: "Trademark_Registration_whyusId" },
    { link: "FAQ", id: "Trademark_Registration_faqId" },
    { link: "Partner Benifits", id: "Trademark_Registration_partnerBenefitId" }
]
        ...
        <Box className='ContanerForHome6Content'>
            ...
            <Box className='middleSectionForHome6Content'>
                <Box className='WithoutAccorionContainer'>
                    {
                        Trademark_RegistrationData.map((e, i) => (
                            <Box id={e.id}>
                                <Text
                                    textAlign="start"
                                    fontWeight="bold"
